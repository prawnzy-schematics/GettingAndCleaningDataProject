...
## welcome to the codebook for my project
This file will act as the codebook for this project and provide information on how to access the source data, execute the R script and understand the transformations and variables used in the code.
